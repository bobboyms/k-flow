...
class LossFunctionsTest {
    ...
    fun derivativeQuadratic() {
        ...
        val v1 = Tensor(values = listOf(1.0, 2.0, 3.0), shape = arrayOf(1,3), requiresGrad = true)
        val v2 = Tensor(values = listOf(1.1, 1.9, 3.2), shape = arrayOf(1,3), requiresGrad = true)
    ...
    @Test
    fun MSE() {
        val v1 = Tensor(values = listOf(1.0, 2.0, 3.0), shape = arrayOf(1,3))
        val v2 = Tensor(values = listOf(1.1, 1.9, 3.2), shape = arrayOf(1,3))
    ...
    @Test
    fun derivativeMSE() {
        val v1 = Tensor(values = listOf(1.0, 2.0, 3.0), shape = arrayOf(1,3), name = "v1", requiresGrad = true)
        val v2 = Tensor(values = listOf(1.1, 1.9, 3.2), shape = arrayOf(1,3), name = "v2", requiresGrad = true)
